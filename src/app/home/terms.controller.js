(function() {
    ...
    TermsController.$inject = ['authFactory', '$ngBootbox', '$stateParams', '$mdDialog', '$state', '$scope'];

    function TermsController(authFactory, $ngBootbox, $stateParams, $mdDialog, $state, $scope) {
        var vm = this;
